...
- 쉼표(,)와 콜론(:)을 구분자로 하여 문자열을 구분자를 기준으로 분리한 각 숫자의 합을 출력한다.
- 기본 구분자는 혼용이 가능하다.
- 기본 구분자 외에 커스텀 구분자를 "//{$커스텀_구분자}\n"으로 커스텀 구분자를 지정하여 사용할 수 있다.
- 추출할 숫자가 없다면 0을 출력한다.
...
- [x] 문자열 덧셈 계산기 저장소를 포크하고 클론하는 것으로 시작한다.
- [x] 기능을 구현하기 전 README.md에 구현할 기능 목록을 정리해 추가한다.
- [x] Git의 커밋 단위는 앞 단계에서 README.md에 정리한 기능 목록 단위로 추가한다. (AngularJS Git Commit Message Conventions을 참고해 커밋 메시지를 작성한다.)
